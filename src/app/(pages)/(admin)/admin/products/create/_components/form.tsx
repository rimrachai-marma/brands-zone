...
export default function ProductForm({ brands, campaigns, categories }: Props) {
  ...
  const form = useForm<ProductFormData>({
    ...
    defaultValues: {
      ...
      images: [{ url: "", alt_text: "", order: 0, publicId: undefined }],
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <ProductImagesSection
          uploadEndpoint="http://brand-zone-backend.test/api/v1/upload/product-image"
          form={form}
        />
        ...
        <div className="flex justify-end gap-4">
          ...
          <Button disabled={isPending || isTransitioning} type="submit">
            <LoadingSwap isLoading={isPending || isTransitioning}>
              Create Product
            </LoadingSwap>
          </Button>
        </div>
