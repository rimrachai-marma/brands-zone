          ...
          <div className="lg:col-span-8 relative">
            <div className="relative h-[300px] sm:h-[350px] md:h-[450px] lg:h-[765px] overflow-hidden ">
              ...
              <div className="absolute inset-0 flex items-center z-10">
                <div className="px-4 sm:px-6 md:px-8 lg:px-16 max-w-lg md:max-w-3xl">
                  {currentSection.title && (
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-white mb-3 sm:mb-4 md:mb-6 leading-snug sm:leading-tight whitespace-normal break-normal text-nowrap">
                      {currentSection.title}
                    </h1>
                  )}

                  {currentSection.subtitle && (
                    <p className="text-sm sm:text-base md:text-lg text-white/90 mb-4 sm:mb-6 md:mb-8 leading-relaxed whitespace-normal break-normal">
                      {currentSection.subtitle}
                    </p>
                  )}
                    ...
                    {heroSections.map((_, idx) => (
                      <button
                        ...
                        className={`transition-all rounded-full ${
                          currentSlide === idx ? "bg-red-600" : "bg-white/50"
                        } ${
